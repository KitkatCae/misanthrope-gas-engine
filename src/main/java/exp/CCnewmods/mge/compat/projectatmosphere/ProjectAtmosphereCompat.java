 ...
 * <p>
 * The Mixins in this package are listed in misanthrope_core_late.mixins.json
 * and target Create classes unconditionally, but the actual PA API calls are
 * wrapped in try/catch in WindmillWindIntegration so nothing explodes if PA
